...
int main(int argc, char** argv){
    ...
    set_PWM_frequency(pi, 4, 3000);
    set_PWM_frequency(pi, 10, 3000);
    set_PWM_frequency(pi, 12, 3000);
    set_PWM_frequency(pi, 18, 3000);
    set_PWM_frequency(pi, 13, 3000);
    set_PWM_frequency(pi, 19, 3000);
    ...
    ros::Subscriber sub = n.subscribe<sensor_msgs::LaserScan>("/scan", 10, scanCallback);
     ...
     while(ros::ok()){
        ...
        if (deg_0 > 0.5){
	        ...
	        set_PWM_dutycycle(pi, 10, 250);
            set_PWM_dutycycle(pi, 12, 0);
	        set_PWM_dutycycle(pi, 18, 250);
            set_PWM_dutycycle(pi, 13, 0);
	        set_PWM_dutycycle(pi, 19, 250);
            set_PWM_dutycycle(pi, 20, 0);
	        set_PWM_dutycycle(pi, 21, 250);
        }else{
            set_PWM_dutycycle(pi, 4, 250);
            set_PWM_dutycycle(pi, 10, 0);
            set_PWM_dutycycle(pi, 12, 250);
            set_PWM_dutycycle(pi, 18, 0);
            set_PWM_dutycycle(pi, 13, 250);
            set_PWM_dutycycle(pi, 19, 0);
